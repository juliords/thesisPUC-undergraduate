...
\begin{itemize}
	...
	\item No cabeçalho do sistema são disponibilizados FAQ, um vídeo com explicação do sistema (que pode ser acessado neste << link >>) e uma área para feedbacks.
...
Todo código gerado foi versionado utilizando-se GIT e hospedado na plataforma GitHub, conforme pode ser acessado pelo link: << Link >>https://github.com/PrismaDev/prisma. Sendo open-source, todos podem contribuir, usar como referência ou mesmo reutilizar projeto como um todo.
