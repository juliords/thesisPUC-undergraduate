...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \resumo{
Na PUC-Rio, no início de cada período os alunos devem informar quais turmas gostariam de cursar no próximo período. No entanto, o número de vagas por turmas é limitado e na maior parte das vezes não é possível atender a todos os pedidos de todos os alunos. Dessa maneira, foi desenvolvido o sistema PrISMA, uma aplicação web de fácil uso cujo objetivo é auxiliar os alunos passo a passo nas suas decisões na hora de montar o seu planejamento de turmas para o período seguinte.
 }
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \resumouk{%
In the beginning of each academic term, PUC-Rio's students must choose those courses they would like to attend. However, there is a maximum number of enrolled students at each course for a given term. PrISMA is an user friendly web-based application that aims at helping the students on their options for enrollments. 
 }
